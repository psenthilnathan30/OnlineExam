                    ...
                    <div class="panel panel-primary">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">View All Exam</span>
                            ...
                            <ul class="chat">
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src="${pageContext.request.contextPath}http://placehold.it/50/55C1E7/fff" alt="User Avatar" class="img-circle" />
                                    </span>
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                        <img src="${pageContext.request.contextPath}http://placehold.it/50/FA6F57/fff" alt="User Avatar" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
                                        <div class="header">
